...
> Historical release-remediation record. Implemented and superseded items are
> retained for provenance; unresolved product work belongs in the active
...
- The **D-series** (design-system shell) has landed its primary screens: `/formats`,
  ...
  ([`design-system-spine.md`](../completed-plans/design-system-spine.md), D4–D8 notes).
- The **Workbench editor dock + graph** were rebuilt to the `ui_kits/workbench`
  spec ([`workbench-integration.md`](../completed-plans/workbench-integration.md)).
- The **Rust core is still bypassed at runtime** for most authority; the live app
  ...
  [`performance-roadmap-through-session-migration.md`](../completed-plans/performance-roadmap-through-session-migration.md) Phases 1–3.
