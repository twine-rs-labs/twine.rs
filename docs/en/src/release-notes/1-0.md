...
- Fixed passage names with full stops no longer failing to have incoming link
  arrows.
...
- You should now be able to put a \] character inside the link syntax
  ...
  \>\> ).
- Shorthand `<<display>>`: variable default was
...
- Mobile Sugarcane layout: I've added a somewhat
